...
# ---------------------------------------------------------------- Streamlit UI
st.set_page_config(page_title="Portfolio LGPD Demo", layout="centered")

st.title("Assistente LGPD com RAG e tool de citação")
st.caption("Pergunte sobre a LGPD, consulte os artigos do corpus e observe o caminho de custo reduzido.")
...
st.divider()
st.caption(
    "Corpus base: LGPD em Markdown, com apoio de tool de citacao por artigo e caches para reduzir custo."
)
